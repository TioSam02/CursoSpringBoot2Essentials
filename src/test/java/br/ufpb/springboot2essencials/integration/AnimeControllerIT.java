package br.ufpb.springboot2essencials.integration;

import br.ufpb.springboot2essencials.domain.Anime;
import br.ufpb.springboot2essencials.domain.DevDojoUser;
import br.ufpb.springboot2essencials.repository.AnimeRepository;
import br.ufpb.springboot2essencials.repository.DevDojoUserRepository;
import br.ufpb.springboot2essencials.requests.AnimePostRequestBody;
import br.ufpb.springboot2essencials.util.AnimeCreator;
import br.ufpb.springboot2essencials.util.AnimePostRequestBodyCreator;
import br.ufpb.springboot2essencials.wrapper.PageableResponse;
...
class AnimeControllerIT {
    ...
    void findByName_ReturnsListOfAnime_WhenSuccessful() {
        ...
        Anime anime1 = animeRepository.save(new Anime(10,"Praia"));

        Anime anime2 = animeRepository.save(new Anime(11,"Praia"));

        List<Anime> animes = animeRepository.findByName("Praia");
