package br.ufpb.springboot2essencials.client;
...
//        log.info("saved anime{}", kingdomSaved);
        ...
        log.info("saved anime{}", samuraiChamplooSaved, createJsonHearder());
        ...
        ResponseEntity<Void> samuraiChamplooUpdated = new RestTemplate(). exchange("http://localhost:8080/animes/", HttpMethod.PUT,
                new HttpEntity<>(animeToBeUpdated, createJsonHearder()),
                Void.class);
